    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                @endif
                <h5 class="card-header">THÊM TRANG</h5>
                <div class="card-body">
                    <form action="{{ url('admin/page/store') }}" method="POST">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <textarea name="desc" class="form-control mt-1 tinymce" id="intro" cols="30" rows="20">{{ old('content') }}</textarea>
                            @error('desc')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <button type="submit" name="btn-add" value="Thêm mới" class="btn btn-primary mt-3">Thêm mới</button>
                    </form>
                </div>
            </div>
        </div>
