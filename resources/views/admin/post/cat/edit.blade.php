        ...
        <div class="row">
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('postcat.update', $category->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group mb-1 mt-3">
                                ...
                                <select id="defaultSelect" class="form-select mt-1" name="parent_id">
                                    <option value="0" @if ($category->parent_id == 0) selected = "selected" @endif>
                                        Chọn danh mục cha</option>
                                    @foreach ($post_cats as $value)
                                        <option value='{{ $category->id }}'
                                            @if ($category->parent_id == $value->id) selected = "selected" @endif>
                            ...
                            <div class="form-group mt-3 mt-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status" id="exampleRadios2"
                                        value="0" @if ($category->status == '0') checked @endif>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                @foreach ($post_cats as $category)
                                    ...
                                    <tr>
                                        <th scope="row">{{ $t }}</th>
                                        <td><a href="{{ route('postcat.edit', $category->id) }}">{{ str_repeat('---|', $category->level) . $category->name }}</a></td>
                                        <td>{{ $category->slug }}</td>
